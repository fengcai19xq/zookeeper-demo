/** 
 * 文件名：ZooKeeperPropertyPlaceholderConfigurer.java 
 * 版本信息：1.0
 * 日期：2015年6月30日-下午1:20:51   
 */
package com.zhaogang.zookeeper.config.spring;
...
import com.zhaogang.zookeeper.config.Config;
import com.zhaogang.zookeeper.config.ZooKeeperConfig;
